...
if (isset($_POST["nic"])) {
    ...
    if (strlen($nic) < 1) {
        ...
        $adminResultset = Database::search("SELECT * FROM `farmer` WHERE `nic`='" . $nic . "'");
        ...
        if ($adminRownumber > 0) {
            ...
            Database::iud("UPDATE `farmer` SET `verification_code`='". $verificationCode ."' WHERE `nic`='". $nic ."'");
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Farmer Signin Verification Code';
