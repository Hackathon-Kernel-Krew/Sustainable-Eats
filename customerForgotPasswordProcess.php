...
if (isset($_POST["email"])) {
    ...
    if (strlen($email) < 1) {
        ...
        $adminResultset = Database::search("SELECT * FROM `customer` WHERE `email`='" . $email . "'");
        ...
        if ($adminRownumber > 0) {
            ...
            Database::iud("UPDATE `customer` SET `verification_code`='". $verificationCode ."' WHERE `email`='". $email ."'");
